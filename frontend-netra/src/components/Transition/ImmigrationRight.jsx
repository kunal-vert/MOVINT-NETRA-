...
const ImmigrationRight = () => {
    return (
        <div className='min-h-screen bg-sky-950 w-full lg:w-2/3 flex flex-col overflow-y-auto pb-10'>
            ...
            <div className='w-[90%] mx-auto bg-red-800 border-[3px] border-red-950 rounded-[7px] p-5'>
            ...
            <div className="w-[90%] mx-auto mt-8 grid grid-cols-2 lg:grid-cols-3 gap-y-8 text-white">
                ...
                <div>
                    ...
                    <p className="font-semibold text-lg text-green-400">No</p>
                </div>
